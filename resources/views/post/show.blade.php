    ...
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">{{$date->translatedFormat('F')}}
                ...
                Коментариев</p>
            <section class="blog-post-featured-img w-75 mx-auto" style="margin-top: -20px" data-aos="fade-up"
                     data-aos-delay="300">
            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    <section class="related-posts">
                        <h2 class="section-title mb-4" style="margin-top: -40px" data-aos="fade-up">Еще публикации по
                            тематике:
